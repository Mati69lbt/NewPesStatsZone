import { SORT_OPTIONS } from '../utils/capitanesResumenSortOptions'

function CapitanesResumenSortBar({ sortKey, sortDir, onSort }) {
  return (
...
export default CapitanesResumenSortBar
